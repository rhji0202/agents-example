...
- docs/specs/ 하위 스펙 문서가 있으면 task 관련 스펙을 확인하고 step에 반영
...
`docs/specs/` 하위에 task와 관련된 스펙 문서가 있으면:
1. 해당 스펙을 step의 "읽어야 할 파일"에 포함
2. 스펙에 정의된 요구사항·인터페이스·규칙을 step 작업 지시에 반영
