...
- Project: `~/.codebuddy/homunculus/projects/<project-hash>/observations.jsonl`
- Global fallback: `~/.codebuddy/homunculus/observations.jsonl`
...
- Project: `~/.codebuddy/homunculus/projects/<project-hash>/instincts/personal/`
- Global: `~/.codebuddy/homunculus/instincts/personal/` (for universal patterns)
