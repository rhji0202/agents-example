...
Write the full plan document using the template below. Save to `.codebuddy/PRPs/plans/{kebab-case-feature-name}.plan.md`.

Create the directory if it doesn't exist:
```bash
mkdir -p .codebuddy/PRPs/plans
```
...
```
.codebuddy/PRPs/plans/{kebab-case-feature-name}.plan.md
```
...
- **File**: .codebuddy/PRPs/plans/{kebab-case-feature-name}.plan.md
- **Source PRD**: [path or "N/A"]
...
> Next step: Run `/prp-implement .codebuddy/PRPs/plans/{name}.plan.md` to execute this plan.
```
