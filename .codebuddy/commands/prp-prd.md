...
**Output path**: `.codebuddy/PRPs/prds/{kebab-case-name}.prd.md`

Create directory if needed: `mkdir -p .codebuddy/PRPs/prds`
...
**File**: `.codebuddy/PRPs/prds/{name}.prd.md`
...
Run: `/prp-plan .codebuddy/PRPs/prds/{name}.prd.md`
...
└─────────────────────────────────────────────────────────┘
                          ↓
┌─────────────────────────────────────────────────────────┐
│  GENERATE: Write PRD to .codebuddy/PRPs/prds/              │
└─────────────────────────────────────────────────────────┘
```
