...
1. **Project rules** — Read `CLAUDE.md`, `.codebuddy/docs/`, and any contributing guidelines
2. **PRP artifacts** — Check `.codebuddy/PRPs/reports/` and `.codebuddy/PRPs/plans/` for implementation context related to this PR
...
Create review artifact at `.codebuddy/PRPs/reviews/pr-<NUMBER>-review.md`:
...
Artifacts:
  Review: .codebuddy/PRPs/reviews/pr-<NUMBER>-review.md
  GitHub: <PR URL>
