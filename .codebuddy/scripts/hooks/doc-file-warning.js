...
const STRUCTURED_DIRS = /(^|\/)(docs|\.codebuddy|\.github|commands|skills|benchmarks|templates|\.history|memory)\//;
  ...
  if (filePath && isSuspiciousDocPath(filePath)) {
    return {
      ...
      stderr:
        ...
        `[Hook] File: ${filePath}\n` +
        '[Hook] Consider using a structured path (e.g. docs/, .codebuddy/, skills/, .github/, benchmarks/, templates/)',
    };
  }
