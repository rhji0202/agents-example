...
function stateFilePath() {
  ...
  return path.join(os.homedir(), '.codebuddy', 'mcp-health-cache.json');
}
...
async function main() {
  ...
  const eventName = process.env.codebuddy_HOOK_EVENT_NAME || 'PreToolUse';
  const now = Date.now();
